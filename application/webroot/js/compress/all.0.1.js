...
(function ($, window, document) {
  ...
  methods.init = function (settings) {
    ...
    return this.each(function () {
      var
        ...
        fitWidth = typeof(settings.fitWidth) != 'undefined' ? settings.fitWidth : true,
      ...
      // ncloud added
      $(document).on('mousedown.dropkick', function( event ) {
  ...
  function _build (tpl, view) {
    ...
    if (view.options && view.options.length) {
      for (var i = 1, l = view.options.length; i < l; i++) {
        var
